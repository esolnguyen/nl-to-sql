...
from constants.sql import TOP_K, TOP_TABLES
...
class TablesSQLDatabaseTool(BaseSQLDatabaseTool, BaseTool):
    ...
    @catch_exceptions()
    def _run(
        self, user_question: str, run_manager: CallbackManagerForToolRun | None = None
    ) -> str:
...
class SchemaSQLDatabaseTool(BaseSQLDatabaseTool, BaseTool):
    ...
    @catch_exceptions()
    def _run(
        self, table_names: str, run_manager: CallbackManagerForToolRun | None = None
    ) -> str:
...
class InfoRelevantColumns(BaseSQLDatabaseTool, BaseTool):
    ...
    @catch_exceptions()
    def _run(
        self, column_names: str, run_manager: CallbackManagerForToolRun | None = None
    ) -> str:
